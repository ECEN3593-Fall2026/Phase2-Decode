...
module cpu (
    ...
    // Needed since versions < 12 of icarus verilog don't like the type cast.
    // if you get an error, compile with: iverilog -DVERNOT12 -g2012 -o system_tb.out -c file_list.txt
    `ifdef VERNOT12
       assign opc = s_id_opc;  
    `else
